...
conditions = {{{'ego2D','ego3D'},{'allo2D','allo3D'},{'control2D','control3D'}}, {{'ego2D','ego3D'},{'allo2D','allo3D'}}, {{'allo2D'}, {'allo3D'}}, {{'ego2D'}, {'ego3D'}}}; % {{'allo2D'}, {'allo3D'}}}; TODO: add other contrasts e.g. 2D vs 3D

if ERPTODO
    freqs = {'ERP',0,0};     
else    
    % the frequency bands to analyze: name, freq range and position in the summary plot (=number of subplot)
    freqs = {'alfa',[8.5 13],2; 'beta', [14 30],3; 'theta', [3 8],5; 'lowgamma', [31 50],8;'highgamma',[51 100],9};       
end
...
for cond = 1:numel(conditions)  % over all conditions groups
    ...
    STUDY = std_makedesign(STUDY, ALLEEG, 4, 'name','STUDY.design_4','delfiles','off','defaultdesign','off','variable1','type','values1', conditions{cond},'vartype1','categorical'...
        ,'subjselect',{'ag20200131','as20200224','db20190128','dw20190325','ez20200207','jk20190418','jm20190401','ks20190322','md20200312','mk20190209','mm20190228','na20190119','pm20190314','tc20190105','vl20190404'}); 
