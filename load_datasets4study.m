...
%     file=dir([SubjectPath '*dipfit.set']); % search for a dataset after dipoles fitting with standard chan loc file
    file=dir([SubjectPath '*digChanLoc.set']);  % with digitized chan loc file
